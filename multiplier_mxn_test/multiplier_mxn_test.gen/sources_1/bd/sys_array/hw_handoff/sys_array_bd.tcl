...
################################################################
# This is a generated script based on design: sys_array
#
...
# source sys_array_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# MbyNMultiplier, scatter
...
proc create_root_design { parentCell } {
  ...
  # Create instance: MbyNMultiplier_0, and set properties
  set block_name MbyNMultiplier
  set block_cell_name MbyNMultiplier_0
  if { [catch {set MbyNMultiplier_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $MbyNMultiplier_0 eq "" } {
  ...
  set block_name scatter
  set block_cell_name scatter_0
  if { [catch {set scatter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $scatter_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net MbyNMultiplier_0_outputMatrix [get_bd_pins MbyNMultiplier_0/outputMatrix] [get_bd_pins scatter_0/InResult]
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins MbyNMultiplier_0/B] [get_bd_pins axi_gpio_0/gpio2_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins MbyNMultiplier_0/A] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins MbyNMultiplier_0/clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  ...
  connect_bd_net -net rst_1 [get_bd_ports rst] [get_bd_pins MbyNMultiplier_0/rst]
  connect_bd_net -net scatter_0_OutResG1_1 [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins scatter_0/OutResG1_1]
  connect_bd_net -net scatter_0_OutResG1_2 [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins scatter_0/OutResG1_2]
  connect_bd_net -net scatter_0_OutResG2_1 [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins scatter_0/OutResG2_1]
  connect_bd_net -net scatter_0_OutResG2_2 [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins scatter_0/OutResG2_2]
  connect_bd_net -net scatter_0_OutResG3_1 [get_bd_pins axi_gpio_3/gpio_io_i] [get_bd_pins scatter_0/OutResG3_1]
  connect_bd_net -net scatter_0_OutResG3_2 [get_bd_pins axi_gpio_3/gpio2_io_i] [get_bd_pins scatter_0/OutResG3_2]
  connect_bd_net -net scatter_0_OutResG4_1 [get_bd_pins axi_gpio_4/gpio_io_i] [get_bd_pins scatter_0/OutResG4_1]
  connect_bd_net -net scatter_0_OutResG4_2 [get_bd_pins axi_gpio_4/gpio2_io_i] [get_bd_pins scatter_0/OutResG4_2]
